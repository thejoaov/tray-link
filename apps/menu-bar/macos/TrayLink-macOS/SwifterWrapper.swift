...
@objc class SwifterWrapper: NSObject {
  ...
  override init() {
    ...
    server.GET["/tlink/open"] = { request in
      ...
      let deeplinkURLString = decodedURLParam.replacingOccurrences(of: "https://", with: "tlink://")
                                             .replacingOccurrences(of: "exp://", with: "tlink://")
