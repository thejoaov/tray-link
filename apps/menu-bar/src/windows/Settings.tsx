    ...
    >
      ...
      <View border="light" rounded="medium" style={styles.box}>
        ...
        <Row align="center" justify="between" style={styles.boxItem}>
          ...
          <Switch
            ...
            disabled={!preferencesLoaded || deletionConfirmationLocked}
      ...
      {favoriteProjects.length > 0 ? (
        <>
          ...
          <TouchableOpacity accessibilityLabel={t('save')} style={styles.saveButton} onPress={handleSaveFavoritesOrder}>
