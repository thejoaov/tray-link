...
export const RemoveProjectWindow = () => {
  ...
  const [deleteFromDisk, setDeleteFromDisk] = useState(pending?.deleteFromDiskDefault ?? false)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity onPress={close} style={[styles.button, styles.buttonSecondary]}>
          <Text style={styles.buttonText}>{t('cancel')}</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={confirm} style={[styles.button, styles.buttonPrimary]}>
          <Text style={[styles.buttonText, styles.buttonTextPrimary]}>{t('remove')}</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
