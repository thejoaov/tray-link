...
import { Theme, webDarkTheme, webLightTheme } from '@fluentui/react-theme'
import { ComponentType, CSSProperties, ReactElement } from 'react'
import { useColorScheme } from 'react-native'

const lightTheme: Theme = {
  ...webLightTheme,
  colorNeutralBackground1: 'var(--tlink-window-background)',
}
...
export const FluentProvider = ({ children, style }: { children: ReactElement; style?: CSSProperties }) => {
