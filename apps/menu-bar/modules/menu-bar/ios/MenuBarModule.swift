...
public class MenuBarModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    AsyncFunction("runCli") { (command: String, arguments: [String], listenerId: Int, promise: Promise) in
      ...
      environment["TRAY_LINK_MENU_BAR"] = "true"
    ...
    AsyncFunction("openPopover") {
      NotificationCenter.default.post(name: NSNotification.Name(rawValue: "TrayLink_OpenPopover"), object: nil)
    }.runOnQueue(.main)
    
    AsyncFunction("closePopover") {
      NotificationCenter.default.post(name: NSNotification.Name(rawValue: "TrayLink_ClosePopover"), object: nil)
    }.runOnQueue(.main)
  ...
  private func getCliResourceNameForArch() -> String {
    return getHardwareArch() == "arm64" ? "tlink-arm64" : "tlink-x64"
  }
}
